...
mousechsh_loader('com.mousechsh.common.cmd.MouseChshFastCgiServerCmd')
...
mousechsh_loader('com.mousechsh.common.cmd.MouseChshRpcServerCmd')
...
mousechsh_loader('com.mousechsh.common.cmd.MouseChshUnionServerCmd')
